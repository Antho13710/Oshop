      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-2 col-md-6 mb-5 mb-lg-0">
            ...
            <?php foreach ($typesFooter as $type) : ?>
              <li> 
                <a href="<?= $router->generate('oshop-catalog-type', ['type_id' => $type->getId()]) ?>" class="text-muted"><?= $type->getName() ?></a>
              </li>
            <?php endforeach ?>
            </ul>
          </div>
          <div class="col-lg-2 col-md-6 mb-5 mb-lg-0">
            ...
            <ul class="list-unstyled">
            <?php foreach ($brandsFooter as $brand) : ?>
              <li> 
                <a href="<?= $router->generate('oshop-catalog-brand', ['brand_id' => $brand->getId()]) ?>" class="text-muted"><?= $brand->getName() ?></a>
              </li>
            <?php endforeach ?>
            </ul>
          </div>
      ...
      <div class="container">
        <div class="row align-items-center">
          <div class="col-md-6 text-center text-md-left">
            <p class="mb-md-0">© <?= date('Y') ?> &circledcirc; oShop by RyuJin13 &circledcirc; Tous droits réservés.</p>
            
          </div>
          <div class="col-md-6">
            <ul class="list-inline mb-0 mt-2 mt-md-0 text-center text-md-right">
              <li class="list-inline-item">
                <a href="<?= $router->generate('user-login') ?>">Admin</a>
              </li>
              <li class="list-inline-item">
